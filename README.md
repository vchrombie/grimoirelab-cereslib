# Ceres [![Build Status](https://github.com/vchrombie/grimoirelab-cereslib/workflows/build/badge.svg)](https://github.com/chaoss/grimoirelab-cereslib/actions?query=workflow:build+branch:master+event:push) [![Coverage Status](https://coveralls.io/repos/github/chaoss/grimoirelab-cereslib/badge.svg?branch=master)](https://coveralls.io/github/chaoss/grimoirelab-cereslib?branch=master)
