...
from cereslib.enrich import SplitEmail, MessageLogFlag, \
    SplitEmailDomain
...
def analyze_git(es_write):
    # INDEX = 'git_gecko'
    # PROJECT = 'gecko'
    # git = Git("https://github.com/mozilla/gecko-dev.git",
    #           "../gecko_all_commits_final_version_no_cm_options_nobrowser_nochrome_notoolkit.log")
